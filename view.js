 ...
 * It enerates the display of the question and the answer options (must show different answer options- put in model? 
 *	one or two of the answers must look similar to the right answer)
...
SimView.prototype.setupControls = function() {
	...
	//add event for checkbox button
	$( ":checkbox" ).click(function() {
		//the students answer should be passed to the controller
	});

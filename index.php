...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="starter-template">
			<div class="container">
				<div class="row">
					<h3 id="questionType">Let Expressions</h3>
					<div id="letExpressionDiv">
					</div>
				</div>
		...
		<script src="app/scripts/letexpressionmodel.js"></script>
		<script src="app/scripts/questionbankmodel.js"></script>
		<script src="app/scripts/model.js"></script>
		<script src="app/scripts/letexpressionview.js"></script>
